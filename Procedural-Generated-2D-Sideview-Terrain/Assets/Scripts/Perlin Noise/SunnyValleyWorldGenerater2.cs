...
public class SunnyValleyWorldGenerater2 : MonoBehaviour
{
    public SunnyValleyWorldRenderer worldRenderer;
    public SunnyValleyBlockmap blockData;

    public SunnyValleyNoiseDataSO heightMapNoiseData, stoneNoiseData, perlin2DData;
    ...
    public float SumNoise(int x, int y, SunnyValleyNoiseDataSO noiseSettings)
    {
        float amplitude = 1;
